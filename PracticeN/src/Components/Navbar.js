    ...
    <View>
      {userData.role === 'customer' ? (
        <View
          ...
          <TouchableOpacity style={{marginLeft: 3}} onPress={GetAllCategories}>
            <Text
              style={{
                color: 'white',
                fontWeight: 'bold',
          ...
          <TouchableOpacity style={{marginLeft: 20}} onPress={GetAllPackages}>
            <Text
              style={{
                color: 'white',
                fontWeight: 'bold',
              ...
              <Icon name="list-alt" size={35} color="#fff" />
            </Text>
          </TouchableOpacity>
          <TouchableOpacity style={{marginLeft: 20}} onPress={Gallery}>
            <Text
              style={{
                color: 'white',
                fontWeight: 'bold',
          ...
          <TouchableOpacity style={{marginLeft: 20}} onPress={Booking}>
            <Text
              ...
              <Icon name="car-rental" size={35} color="#fff" />
            </Text>
          </TouchableOpacity>

          <TouchableOpacity style={{marginLeft: 20}} onPress={Feedback}>
            <Text
              style={{
                color: 'white',
                fontWeight: 'bold',
              ...
              <Icon name="local-post-office" size={35} color="#fff" />
            </Text>
          </TouchableOpacity>
        ...
        <View
          ...
          <TouchableOpacity style={{marginLeft: 20}} onPress={Users}>
            <Text
              ...
              <Icon name="supervisor-account" size={35} color="#fff" />
            </Text>
          </TouchableOpacity>
